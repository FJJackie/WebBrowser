...
public class LoginActivity extends BaseActivity
    ...
    private void initViews() {
        to_register = (ImageView) findViewById(R.id.to_register);
...
//       return password;   //解码一下
    ...
    private void login() {
        ...
        Thread loginRunnable = new Thread() {
            ...
            public void run() {
                ...
                //判断账号和密码
                if (getAccount().equals("feng") && getPassword().equals("123456")) {
                    showToast("登录成功");
    ...
    public void showToast(String msg) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(LoginActivity.this, tipMsg, Toast.LENGTH_SHORT).show();
            }
        });
    }
